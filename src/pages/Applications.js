      ...
      <div style={{ marginLeft: "90px" }}>
        ...
        <table>
          <tr>
            ...
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-tJLDZLuccv9kOhd2JyAA'><img src='./images/flags/AMERICAN_SAMOA.jpg' /><br />American Samoa</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-enOvtFlvgYSZJtiCPqHb'><img src='./images/flags/COOK_ISLANDS.jpg' /><br />Cook Islands</a></td>
          ...
          <tr>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-sR2GQ9WKBspYvOIDbwCL'><img src='./images/flags/NAURU.jpg' /><br />Nauru</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-eCSwAdB5QyyBxZhWKMVA'><img src='./images/flags/NEW_CALEDONIA.jpg' /><br />New Caledonia</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-aB6Jz7d4YBcepq71mrFK'><img src='./images/flags/NIUE.jpg' /><br />Niue</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-7CvXcQg0UzVqyD6riaH5'><img src='./images/flags/NORTHERN_MARIANA_ISLANDS.jpg' /><br />Northern Mariana</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-AfBk4f3v2E9TBDa1jrXX'><img src='./images/flags/PALAU.jpg' /><br />Palau</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-CEKze5xfIsVRZce8cmnW'><img src='./images/flags/PAPUA_NEW_GUINEA.jpg' /><br />Papua New Guinea</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-atCJ60plKDQCmqQOFYVZ'><img src='./images/flags/PITCAIRN.jpg' /><br />Pitcairn</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-YgzjvZYR1QyV4bkUuJiI'><img src='./images/flags/SAMOA.jpg' /><br />Samoa</a></td>
          ...
          <tr>
            ...
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-hUdTy8OsRIBHaOKcLbos'><img src='./images/flags/VANUATU.jpg' /><br />Vanuatu</a></td>
            <td style={{ padding: '20px' }}><a target="_blank" href='https://maps.digitalearthpacific.org/#share=s-iPZKkNRrAICPXZf6Q6QG'><img src='./images/flags/WALLIS_AND_FUTUNA.jpg' /><br />Wallis And Futuna</a></td>
